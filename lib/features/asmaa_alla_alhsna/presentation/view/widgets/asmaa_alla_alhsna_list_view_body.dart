...
import 'asmaa_alla_alhsna_section_item.dart';

class AsmaaAllaAlhsnaListViewBody extends StatelessWidget {
  const AsmaaAllaAlhsnaListViewBody({super.key});
  @override
            ...
            return AnimationConfiguration.staggeredList(
                ...
                child: SlideAnimation(
                  ...
                  child: FadeInAnimation(
                    child: AsmaaAllaAlhsnaSectionItem(
                      id: index,
                    ),
                  ),
                ));
